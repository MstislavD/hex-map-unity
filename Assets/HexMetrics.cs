...
public static class HexMetrics
{
    ...
    public const float innerToOuter = 1 / outerToInner;
    ...
    public static Vector3 GetSolidEdgeMiddle(HexDirection direction) => (corners[(int)direction] + corners[(int)direction + 1]) * (0.5f * solidFactor);
    ...
    public static Color ColorLerp(Color a, Color b, int step)
    {
        float h = step * horizontalTerraceStepSize;
