...
public class HexGridChunk : MonoBehaviour
{
    ...
    private void TriangulateWater(HexDirection direction, HexCell cell, Vector3 center)
    {
        ...
        {
            TriangulateShore(direction, cell, neighbor, center);
        }
        else
        {
    ...
    void TriangulateShore(HexDirection direction, HexCell cell, HexCell neighbor, Vector3 center)
    {
    ...
    private void TriangulateConnection(HexDirection direction, HexCell cell, EdgeVertices e1)
    {
        ...
        if (hasRiver)
        {
            ...
            if (!cell.IsUnderwater)
            {
                ...
                {
                    TriangulateRiverQuad(e1.v2, e1.v4, e2.v2, e2.v4, cell.RiverSurfaceY, cell.GetNeighbor(direction).RiverSurfaceY, 0.8f, cell.HasIncomingRiver && cell.IncomingRiver == direction);
                }
    ...
    private void TriangulateEdgeTerraces(EdgeVertices begin, HexCell beginCell, EdgeVertices end, HexCell endCell, bool hasRoad)
    {
        ...
        Color c2 = HexMetrics.ColorLerp(beginCell.Color, endCell.Color, 1);
        ...
        for (int i = 2; i < HexMetrics.terraceSteps; i++)
        {
            ...
            c2 = HexMetrics.ColorLerp(beginCell.Color, endCell.Color, i);
    ...
    void TriangulateCornerTerraces(Vector3 begin, HexCell beginCell, Vector3 left, HexCell leftCell, Vector3 right, HexCell rightCell)
    {
        ...
        Color c3 = HexMetrics.ColorLerp(beginCell.Color, leftCell.Color, 1);
        Color c4 = HexMetrics.ColorLerp(beginCell.Color, rightCell.Color, 1);
        ...
        for (int i = 2; i < HexMetrics.terraceSteps; i++)
        {
            ...
            c3 = HexMetrics.ColorLerp(beginCell.Color, leftCell.Color, i);
            c4 = HexMetrics.ColorLerp(beginCell.Color, rightCell.Color, i);
    ...
    private void TriangulateBoundaryTriangle(Vector3 begin, HexCell beginCell, Vector3 left, HexCell leftCell, Vector3 boundary, Color boundaryColor)
    {
        ...
        Color c2 = HexMetrics.ColorLerp(beginCell.Color, leftCell.Color, 1);
        ...
        for (int i = 2; i < HexMetrics.terraceSteps; i++)
        {
            ...
            c2 = HexMetrics.ColorLerp(beginCell.Color, leftCell.Color, i);
    ...
    void TriangulateRoadAdjacentToRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        Vector3 interpolators = GetRoadInterpolators(direction, cell);
    ...
    void TriangulateEstuary(EdgeVertices e1, EdgeVertices e2, bool incomingRiver)
    {
        ...
        estuaries.AddQuadUV(new Vector2(0f, 1f), new Vector2(0f, 0f), new Vector2(1f, 1f), new Vector3(0f, 0f));
        estuaries.AddTriangleUV(new Vector2(0f, 0f), new Vector2(1f, 1f), new Vector2(1f, 1f));
        estuaries.AddQuadUV(new Vector2(0f, 0f), new Vector2(0f, 0f), new Vector2(1f, 1f), new Vector3(0f, 1f));
